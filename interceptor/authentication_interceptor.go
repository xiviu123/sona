...
func AuthenticationInterceptor() grpc.UnaryServerInterceptor {
	return func(ctx context.Context, req interface{}, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (interface{}, error) {
		...
		if !ok {
			...
			//If Service doesn't implement Authenticator. Authentication is accepted
			//Can change this action to require implement Authenticator by return InternalServerError
